...
class BlueprintTest {
    ...
    void リクエストを引数に実行すると図面が返却されること() {
        ...
        MockMultipartFile mockImage = new MockMultipartFile("imageFile", "image.png", "image/png", dummyImageFile);
        AddBlueprintRequest request = new AddBlueprintRequest(siteId, name, "2025-01-01", mockImage);
