...
class ArchitecturalDrawingMapperTest {
    ...
    List<ArchitecturalDrawing> createSampleArchitecturalDrawingList() {
        return new ArrayList<ArchitecturalDrawing>(
                Arrays.asList(
                        new ArchitecturalDrawing("11000000-0000-1000-8000-000000000001", "10000000-0000-1000-8000-000000000001", "2025-01-01", "/static/image/floor_plan1.png"),
                        new ArchitecturalDrawing("11000000-0000-1000-8000-000000000002", "10000000-0000-1000-8000-000000000002", "2025-01-01", "/static/image/wiring_diagram1.png"),
                        new ArchitecturalDrawing("11000000-0000-1000-8000-000000000003", "10000000-0000-1000-8000-000000000003", "2025-01-01", "/static/image/elevation.png")
                )
        );
    }
    ...
    void 図面画像情報の検索＿図面idに該当する図面画像情報が全件返却されること() {
        String blueprintId = "10000000-0000-1000-8000-000000000001";
        List<ArchitecturalDrawing> expected = List.of(new ArchitecturalDrawing("11000000-0000-1000-8000-000000000001", "10000000-0000-1000-8000-000000000001", "2025-01-01", "/static/image/floor_plan1.png"));
    ...
    void 図面画像情報の追加＿図面画像情報が追加されること() {
        String blueprintId = "10000000-0000-1000-8000-000000000001";
        ArchitecturalDrawing newArchitecturalDrawing = new ArchitecturalDrawing("11000000-0000-1000-8000-000000000004", blueprintId, "2025-01-02", "/static/image/floor_plan2.png");
        architecturalDrawingList.add(newArchitecturalDrawing);
        List<ArchitecturalDrawing> expected = List.of(
                new ArchitecturalDrawing("11000000-0000-1000-8000-000000000001", "10000000-0000-1000-8000-000000000001", "2025-01-01", "/static/image/floor_plan1.png"),
                new ArchitecturalDrawing("11000000-0000-1000-8000-000000000004", "10000000-0000-1000-8000-000000000001", "2025-01-02", "/static/image/floor_plan2.png")
        );
