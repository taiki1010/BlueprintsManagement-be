...
class ArchitecturalDrawingServiceTest {
    ...
    public void before() {
        ...
        architecturalDrawingMockedStatic.when(
                        () -> ArchitecturalDrawing.formArchitecturalDrawing(any(), any()))
                .thenReturn(architecturalDrawing);
    }
    ...
    public void createInitialSampleDate() {
        ...
        architecturalDrawingRequest = new ArchitecturalDrawingRequest(blueprintId, "2025-01-01",
                mockImage);
    }
    ...
    class addArchitecturalDrawingTest {
        ...
        @Test
        void 図面画像情報の追加＿リポジトリとputObjectメソッドが実行されること()
        ...
        @Test
        void 図面画像情報の追加＿putObjectメソッドが失敗したとき例外処理が発生すること()
                throws IOException, FailedToPutObjectException {
